...
function RunOverview({ copy, analysis }: { copy: Copy; analysis: TrainingRunAnalysis }) {
  const trainingCases = useMemo(() => analysis.cases.filter((item) => item.phase === "training"), [analysis.cases]);
